...
function SWEP:Initialize()
    -- Initialize ironsights and other state variables
    ...
    -- Ensure HoldType is defined, otherwise set a default
    if not self.HoldType then
        self.HoldType = "pistol"  -- Choose a valid hold type here
    end

    -- Set the hold type
    self:SetHoldType(self.HoldType)

    -- Set custom material if defined
